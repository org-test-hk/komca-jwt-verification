package kr.or.komca.foundation.jwt.global.filter;
...
import kr.or.komca.foundation.jwt.global.exception.filterException.InvalidTokenException;
import kr.or.komca.foundation.jwt.global.exception.filterException.MissingFingerprintException;
import kr.or.komca.foundation.jwt.global.exception.filterException.MissingTokenException;
import kr.or.komca.foundation.jwt.global.exception.filterException.TokenValidationException;
...
public class JwtAuthenticationFilter extends OncePerRequestFilter {
    ...
    private final TokenVerificationCommandService tokenVerificationCommandService;
...
//    private final Set<String> skipPatterns = new HashSet<String>();
    ...
    private void processAuthentication(HttpServletRequest request) {
        ...
        if (!StringUtils.hasText(fingerprint)) {
            ...
            tokenVerificationCommandService.logAbnormalAccess(jwt, SecurityConstants.EVENT_MISSING_FINGERPRINT, request);
